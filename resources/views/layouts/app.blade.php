...
<body>
                    ...
                    <div class="slider-active owl-carousel">
                        <div class="single-slider single-slider-hm1 bg-img height-100vh" style="background-image: url(assets/img/slider/15.jpg)">
                            <div class="slider-content slider-animation slider-content-style-1 slider-animated-1">
                                <h1 class="animated text-white">Fashion</h1>
                                <p class="animated text-white">Create you own style for better looks. </p>
                            </div>
                        ...
                        <div class="single-slider single-slider-hm1 bg-img height-100vh" style="background-image: url(assets/img/slider/16.jpg)">
    ...
    <footer class="footer-area">
        <div class="footer-top-area bg-img pt-105 pb-65" style="" data-overlay="9">
            <div class="container">
                <div class="row">
